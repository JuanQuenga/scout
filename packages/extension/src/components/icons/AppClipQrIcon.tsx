...
// Hugeicons QrCodeIcon, @hugeicons/core-free-icons 4.3.2.
// License ships in public/third-party-licenses/hugeicons.txt.
export function AppClipQrIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
    ...
    >
      ...
      <path d="M3 12L9 12" strokeLinecap="round" strokeLinejoin="round" />
      ...
      <path d="M21 12H15C13.5858 12 12.8787 12 12.4393 12.4393C12 12.8787 12 13.5858 12 15M12 17.7692V20.5385M15 15V16.5C15 17.9464 15.7837 18 17 18C17.5523 18 18 18.4477 18 19M16 21H15M18 15C19.4142 15 20.1213 15 20.5607 15.44C21 15.8799 21 16.5881 21 18.0043C21 19.4206 21 20.1287 20.5607 20.5687C20.24 20.8898 19.7767 20.9766 19 21" strokeLinecap="round" />
    </svg>
  );
}
